...
| ----------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Trabaja en equipo para proporcionar liderazgo en forma conjunta                                 | **AV1**<br>**Cuba Pareja, Joaquin Antonio**<br>Coordiné el Sprint Planning 1, participé en la integración mediante Git Flow e implementé US001, US007 y US008. También contribuí en la definición de segmentos, User Stories, Product Backlog, diseño de la Landing Page, EventStorming y User Flows.<br>**Cuba Vega, Darnell Yadir**<br>Coordiné la implementación de la navegación y los planes de la Landing Page, lideré las ramas `feature/US002` y `feature/US006`, y colaboré en la integración del Sprint 1 mediante Git Flow. Además, documenté el backlog, la matriz de liderazgo y colaboración, la evidencia de ejecución y despliegue, las convenciones de código, el prototipo web, los diagramas de clases y el Design-Level EventStorming.<br>**Condori Urviola, Mateo Sebastián**<br>Coordiné US003, definiendo el camino del hotel independiente y el plan Free de la Landing Page, y participé en la integración mediante Git Flow. También contribuí al análisis competitivo y a la definición del problema, assumptions e hipótesis de Lean UX.<br>**Flores Rios, Juan Diego**<br>Coordiné US004, definiendo el camino de la cadena hotelera pequeña y el plan Professional de la Landing Page. También colaboré en el análisis de impactos y en el diseño de los artefactos del producto.<br>**Santana Luna, José Antonio**<br>Coordiné US005, definiendo los beneficios de operaciones conectadas y el flujo operativo de la Landing Page. También participé en la documentación colaborativa de entrevistas, arquitectura y gestión del proyecto.<br><br>**TB1**<br>**Cuba Pareja, Joaquin Antonio**<br>**Cuba Vega, Darnell Yadir**<br>**Condori Urviola, Mateo Sebastián**<br>**Flores Rios, Juan Diego**<br>**Santana Luna, José Antonio**<br><br>**AV2**<br>**Cuba Pareja, Joaquin Antonio**<br>**Cuba Vega, Darnell Yadir**<br>**Condori Urviola, Mateo Sebastián**<br>**Flores Rios, Juan Diego**<br>**Santana Luna, José Antonio**<br><br>**TB2**<br>**Cuba Pareja, Joaquin Antonio**<br>**Cuba Vega, Darnell Yadir**<br>**Condori Urviola, Mateo Sebastián**<br>**Flores Rios, Juan Diego**<br>**Santana Luna, José Antonio** | **AV1**<br>**Cuba Pareja, Joaquin Antonio**<br>Mi conclusión es que mi liderazgo combinó coordinación y ejecución técnica, facilitando que el equipo avanzara de forma integrada desde el análisis hasta la implementación.<br>**Cuba Vega, Darnell Yadir**<br>Mi conclusión es que mi participación combinó liderazgo funcional y documentación técnica, ayudando a mantener alineadas las responsabilidades del equipo y la evolución del producto.<br>**Condori Urviola, Mateo Sebastián**<br>Mi conclusión es que mi trabajo conectó el análisis del usuario con una experiencia concreta para hoteles independientes.<br>**Flores Rios, Juan Diego**<br>Mi conclusión es que mi trabajo conectó la estrategia del producto con una experiencia clara para cadenas pequeñas.<br>**Santana Luna, José Antonio**<br>Mi conclusión es que mi trabajo conectó los beneficios operativos con un flujo comprensible y una base técnica para continuar el producto.<br><br>**TB1**<br>**Cuba Pareja, Joaquin Antonio**<br>**Cuba Vega, Darnell Yadir**<br>**Condori Urviola, Mateo Sebastián**<br>**Flores Rios, Juan Diego**<br>**Santana Luna, José Antonio**<br><br>**AV2**<br>**Cuba Pareja, Joaquin Antonio**<br>**Cuba Vega, Darnell Yadir**<br>**Condori Urviola, Mateo Sebastián**<br>**Flores Rios, Juan Diego**<br>**Santana Luna, José Antonio**<br><br>**TB2**<br>**Cuba Pareja, Joaquin Antonio**<br>**Cuba Vega, Darnell Yadir**<br>**Condori Urviola, Mateo Sebastián**<br>**Flores Rios, Juan Diego**<br>**Santana Luna, José Antonio** |
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos. | **AV1**<br>**Cuba Pareja, Joaquin Antonio**<br>Definí el objetivo y la métrica del sprint, organicé el backlog y contribuí al cumplimiento de 8/8 User Stories y al despliegue en GitHub Pages. Además, documenté estándares, estructura del informe y evidencias del proceso.<br>**Cuba Vega, Darnell Yadir**<br>Definí y organicé tareas del Sprint 1 para US002 y US006, descomponiendo la navegación, la página de términos, la comparación de planes y las acciones de cierre. También elaboré evidencias de desarrollo, ejecución y despliegue, y documenté arquitectura, convenciones y prototipos para contribuir al cumplimiento de las ocho User Stories y la publicación de la Landing Page.<br>**Condori Urviola, Mateo Sebastián**<br>Definí las tareas y artefactos de US003; elaboré wireframes y wireflows, documenté User Stories y servicios de habitaciones, y aporté al diseño de la solución.<br>**Flores Rios, Juan Diego**<br>Definí y documenté User Stories y servicios de inventario, elaboré mockups de alta fidelidad y contribuí al Impact Mapping y a los sistemas de búsqueda y organización.<br>**Santana Luna, José Antonio**<br>Definí las tareas y artefactos de US005; documenté entrevistas y su análisis, servicios de RFID y reporting, diagramas de arquitectura y la configuración de los repositorios.<br><br>**TB1**<br>**Cuba Pareja, Joaquin Antonio**<br>**Cuba Vega, Darnell Yadir**<br>**Condori Urviola, Mateo Sebastián**<br>**Flores Rios, Juan Diego**<br>**Santana Luna, José Antonio**<br><br>**AV2**<br>**Cuba Pareja, Joaquin Antonio**<br>**Cuba Vega, Darnell Yadir**<br>**Condori Urviola, Mateo Sebastián**<br>**Flores Rios, Juan Diego**<br>**Santana Luna, José Antonio**<br><br>**TB2**<br>**Cuba Pareja, Joaquin Antonio**<br>**Cuba Vega, Darnell Yadir**<br>**Condori Urviola, Mateo Sebastián**<br>**Flores Rios, Juan Diego**<br>**Santana Luna, José Antonio** | **AV1**<br>**Cuba Pareja, Joaquin Antonio**<br>Mi conclusión es que mi trabajo ayudó a convertir objetivos y tareas compartidas en artefactos trazables y una entrega funcional.<br>**Cuba Vega, Darnell Yadir**<br>Mi conclusión es que la planificación y la documentación que realicé hicieron trazable el trabajo del sprint y ayudaron a convertir el backlog en una entrega publicada.<br>**Condori Urviola, Mateo Sebastián**<br>Mi conclusión es que los artefactos que elaboré hicieron más clara y trazable la transición desde las necesidades hasta la implementación.<br>**Flores Rios, Juan Diego**<br>Mi conclusión es que los artefactos de impacto, diseño e inventario facilitaron una visión trazable de las necesidades y funcionalidades.<br>**Santana Luna, José Antonio**<br>Mi conclusión es que la documentación de investigación, arquitectura y configuración hizo más trazable la evolución del proyecto.<br><br>**TB1**<br>**Cuba Pareja, Joaquin Antonio**<br>**Cuba Vega, Darnell Yadir**<br>**Condori Urviola, Mateo Sebastián**<br>**Flores Rios, Juan Diego**<br>**Santana Luna, José Antonio**<br><br>**AV2**<br>**Cuba Pareja, Joaquin Antonio**<br>**Cuba Vega, Darnell Yadir**<br>**Condori Urviola, Mateo Sebastián**<br>**Flores Rios, Juan Diego**<br>**Santana Luna, José Antonio**<br><br>**TB2**<br>**Cuba Pareja, Joaquin Antonio**<br>**Cuba Vega, Darnell Yadir**<br>**Condori Urviola, Mateo Sebastián**<br>**Flores Rios, Juan Diego**<br>**Santana Luna, José Antonio** |
...
Las siguientes historias especifican los requisitos del producto digital de Hostera a
partir de las necesidades de sus segmentos objetivo y de los flujos operativos
identificados para el Landing Page y la Web Application. Cada Epic agrupa un conjunto
coherente de capacidades y cada Story incluye criterios de aceptación comprobables.
Las Technical Stories describen requisitos de integración del RESTful API desde la
perspectiva de un Developer y no generan Wireflow User Goals.
...
| TS013 | Manage storage locations through the API | As a developer, I want to manage property storage locations through the API so that inventory items and movements remain associated with valid operational areas. | **Scenario: Create a storage location**<br>**Given** a valid and unique location payload<br>**When** the developer sends `POST /api/v1/properties/{propertyId}/storage-locations`<br>**Then** the API returns `201 Created` with the storage-location resource.<br><br>**Scenario: Update a storage location**<br>**Given** the location exists and the requester is authorized<br>**When** the developer sends `PATCH /api/v1/storage-locations/{locationId}`<br>**Then** the API returns `200 OK` with the updated location while preserving movement history.<br><br>**Scenario: Reject removal of a location in use**<br>**Given** items or stock remain assigned to the location<br>**When** the developer sends `DELETE /api/v1/storage-locations/{locationId}`<br>**Then** the API returns `409 Conflict` and preserves the location. | EP005 |
| TS014 | Manage RFID credentials through the API | As a developer, I want to encode, retrieve, replace, and revoke RFID credentials through the API so that clients and compatible encoders maintain controlled access. | **Scenario: Encode an authorized credential**<br>**Given** a valid person, access scope, validity period, compatible encoder, and blank card<br>**When** the developer sends `POST /api/v1/properties/{propertyId}/rfid-credentials/encode`<br>**Then** the API returns `201 Created` with the credential reference, assignment, scope, validity, and active status.<br><br>**Scenario: Report an encoder failure**<br>**Given** the selected encoder or blank card cannot complete the operation<br>**When** the developer submits the encoding request<br>**Then** the API returns `503 Service Unavailable` with a machine-readable device condition and does not activate the credential.<br><br>**Scenario: Revoke a credential**<br>**Given** an active credential and a valid revocation reason<br>**When** the developer sends `POST /api/v1/rfid-credentials/{credentialId}/revoke`<br>**Then** the API returns `200 OK` with the revoked status and audit information.<br><br>**Scenario: Replace a revoked credential**<br>**Given** the previous credential is revoked and a compatible blank card is available<br>**When** the developer submits a replacement encoding request<br>**Then** the API returns `201 Created` with a new credential linked to the replacement history. | EP006 |
